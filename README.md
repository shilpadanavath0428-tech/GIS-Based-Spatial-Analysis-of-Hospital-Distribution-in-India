...
Healthcare infrastructure is vital for public health and equitable development. Uneven hospital distribution creates regional disparities and limits access to care. This study uses GIS-based spatial analysis of national hospital data to examine state-wise distribution patterns and identify gaps to support better healthcare planning.
import pandas as pd
